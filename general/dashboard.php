...
<head>
    ...
    <!-- Generated: 2021-11-22 09:29:05 +0200 -->
...
<a class="dropdown-item" href="/general/logout.php">Logout</a>
</div>
</div>
</div>
</div>
...
<?php
$connect1 = mysqli_connect("localhost", "root", "", "general");
$sql=mysqli_query($connect1,"select * from user where role='1'");
...
<?php
$connect1 = mysqli_connect("localhost", "root", "", "general");
$sql=mysqli_query($connect1,"select * from user where role='2'");
if(mysqli_num_rows($sql)>0){
while($app=mysqli_fetch_assoc($sql)){
$id=$app['id'];
$name=$app['name'];
