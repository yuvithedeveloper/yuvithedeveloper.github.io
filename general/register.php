...
<form action="/general/api/register.php" method="post" enctype="multipart/form-data" autocomplete="off" id="auth-form">
...
Already have account? <a href="/general">Sign in</a>
</div>
</div>
</div>
<body>
