...
<form action="/finance/api/register.php" method="post" enctype="multipart/form-data" autocomplete="off" id="auth-form">
...
Already have account? <a href="/finance">Sign in</a>
</div>
</div>
</div>
<body>
