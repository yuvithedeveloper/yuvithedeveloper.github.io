...
<form action="/technical/api/register.php" method="post" enctype="multipart/form-data" autocomplete="off" id="auth-form">

<div class="mb-3">
<label class="form-label" for="email">Name</label>
<input type="text" class="form-control" placeholder="you@example.com" required value="" id="email" name="name">
</div>
<div class="mb-3">
<label class="form-label" for="email">Email address</label>
<input type="email" class="form-control" pattern=".+@nhitm\.ac\.in" placeholder="you@example.com" required value="" id="email" name="mob">
</div>
<div class="mb-3">
...
Already have account? <a href="/technical">Sign in</a>
</div>
</div>
</div>
<body>
